...
exports.details = (sender) => {
    messenger.send({text: `Le plafond d'abondement de votre société est de 2200,00€ mensuels pour l'épargne salariale. Pour plus d'informations, contactez votre responsable épargne au +33 1 72 10 94 00`}, sender);
};
